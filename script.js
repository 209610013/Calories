...
function initializeButtons() {
    ...
    resetMealButton.addEventListener("click", () => {
        appetizer = { protein: 0, carbohydrates: 0, fat: 0, calories: 0 };
        entree = { protein: 0, carbohydrates: 0, fat: 0, calories: 0 };
        dessert = { protein: 0, carbohydrates: 0, fat: 0, calories: 0 };
